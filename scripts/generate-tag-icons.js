...
// Simple generator to create 64x64 SVG icons for each tag key used in TAG_EMOJI.
// It is safe to re-run; existing files will be overwritten.
...
function pickPalette(index) {
  const palettes = [
    { bg: '#111827', fg: '#f97316' }, // midnight + orange
    { bg: '#1f2933', fg: '#3b82f6' }, // deep blue + blue
    { bg: '#111827', fg: '#ec4899' }, // midnight + pink
    { bg: '#111827', fg: '#a855f7' }, // midnight + violet
    { bg: '#111827', fg: '#22c55e' }, // midnight + green
    { bg: '#111827', fg: '#eab308' }, // midnight + gold
    { bg: '#111827', fg: '#14b8a6' }, // midnight + teal
    { bg: '#111827', fg: '#f97316' }  // repeat
  ];
...
function generateIconSvg(key, index) {
  ...
  const center = 32;
  const radius = 18 + (index % 6); // slight size variation
  const angle = (index * 37) % 360; // pseudo-random rotation
